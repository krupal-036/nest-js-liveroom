        ...
        <div className="flex h-full min-h-0 flex-col overflow-hidden rounded-2xl border border-stone-200/80 bg-white shadow-card dark:border-stone-800/80 dark:bg-ink">
                    ...
                    {!joinedRoom ? (
                        <div className="flex h-full flex-col items-center justify-center gap-3 text-center">
                            ...
                            <p className="max-w-xs text-sm leading-relaxed font-medium text-stone-400 dark:text-stone-500">
                                No room selected. Set your display name and join a room to start the
                                conversation.
                            </p>
                        </div>
                    ) : (
                        <>
                                    ...
                                    <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:gap-2.5">
                                        {activeUsers.map((user, idx) => {
                                            ...
                                            return (
                                                <div
                                                    key={idx}
                                                    className={`group flex items-center gap-2.5 rounded-xl border px-3 py-2 transition-all duration-300 ease-out sm:py-1.5 ${
                                                        isCurrentUser
                                                ...
                                                >
                                                    <div className="relative shrink-0">
                                                        <span
                                                            className={`flex h-6 w-6 items-center justify-center rounded-full text-[10px] font-bold text-white uppercase transition-transform duration-300 group-hover:scale-105 ${
                                                                isCurrentUser
                            ...
                            {messages.map((msg, index) => {
                                ...
                                if (displayText.startsWith("[Reply to @")) {
                                    const firstUserMatch =
                                        displayText.match(/^\[Reply to @([^:]+):/);
                                    const replyUser = firstUserMatch
                                        ? firstUserMatch[1]
                                        : "Unknown";
                                    ...
                                    if (quoteMatches && quoteMatches.length > 0) {
                                        quoteText = quoteMatches[quoteMatches.length - 1].replace(
                                            /"/g,
                                            "",
                                        );
                                    } else {
                                ...
                                const needsDivider =
                                    index === 0 || dateKeys[index] !== dateKeys[index - 1];
                                    ...
                                    <React.Fragment key={index}>
                                        {needsDivider && (
                                            <div
                                                ...
                                                className="my-4 flex items-center justify-center gap-3 px-2"
                                            >
                                        ...
                                        <div
                                            className={`flex flex-col ${isSystem ? "my-2 items-center justify-center" : isMe ? "items-end" : "items-start"}`}
                                        >
                                            {isSystem ? (
                                                ...
                                                <div
                                                    ...
                                                    className={`group relative mb-3 max-w-[85%] cursor-pointer rounded-2xl px-4 py-3 shadow-card transition-all duration-200 ease-out sm:max-w-[75%] ${
                                                        isMe
                                                ...
                                                >
                                                    ...
                                                    {replyContext && (
                                                        <div
                                                            className={`mb-2.5 rounded-lg border-l-2 p-2.5 text-xs ${
                                                                isMe
                                                    ...
                                                    <p
                                                        className={`text-sm leading-relaxed font-normal tracking-wide break-words whitespace-pre-wrap ${isMe ? "text-white" : "text-stone-800 dark:text-stone-200"}`}
                                                    >
                                                        {displayText}
                                                    </p>
                                                    ...
                                                    {msg.file && (
                                                        <div
                                                            className={`mt-2.5 flex max-w-sm items-center gap-3 rounded-xl border p-2.5 ${
                                                                isMe
                                                        ...
                                                        >
                                                            {msg.file.fileType.startsWith(
                                                                ...
                                                                <div
                                                                    className={`flex h-12 w-12 shrink-0 flex-col items-center justify-center rounded-lg font-mono text-[10px] font-bold tracking-wider uppercase shadow-sm ${
                                                                        isMe
                                                            ...
                                                            <div className="min-w-0 flex-1">
                                                                <span
                                                                    className={`block truncate text-xs font-semibold tracking-wide ${isMe ? "text-white" : "text-stone-800 dark:text-stone-200"}`}
                                                                >
                                                                    {msg.file.fileName}
                                                                </span>
                                                                <span
                                                                    className={`mt-0.5 block font-mono text-[10px] ${isMe ? "text-emerald-100/80" : "text-stone-500 dark:text-stone-400"}`}
                                                                >
                                                                    {(
                                                                        msg.file.fileSize / 1024
                                                                    ).toFixed(1)}{" "}
                                                                    KB
                                                                </span>
                                                            </div>
                                                    ...
                                                    {msg.timestamp && (
                                                        <span
                                                            className={`mt-1.5 block text-right font-mono text-[10px] leading-none tabular-nums ${isMe ? "text-emerald-100/70" : "text-stone-400 dark:text-stone-500"}`}
                                                        >
                                                    ...
                                                    <div
                                                        ...
                                                        className={`absolute -top-4 z-30 flex items-center gap-0.5 rounded-full border border-stone-200/90 bg-white/95 p-1 shadow-pop backdrop-blur-md transition-all duration-200 ease-out dark:border-stone-700/80 dark:bg-ink-soft/95 ${
                                                            activeActionsId === msgId
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            {showReactionPicker === msgId && (
                                                                <div
                                                                    className={`absolute bottom-full z-50 mb-2.5 overflow-hidden rounded-2xl border border-stone-200 shadow-pop animate-scale-in dark:border-stone-800 ${isMe ? "right-0" : "left-0"}`}
                                                                >
                                                                    <EmojiPicker
                                                                        theme={
                                                                            isDarkMode
                                                    ...
                                                    {Object.keys(msgReactions).length > 0 && (
                                                        <div
                                                            className={`absolute -bottom-3.5 z-20 flex flex-wrap items-center gap-1.5 rounded-full border px-2 py-0.5 shadow-card backdrop-blur-sm ${
                                                                isMe
                                                        ...
                                                        >
                                                            {Object.entries(
                                                                Object.entries(msgReactions).reduce(
                                                                    (
                                                                        acc: any,
                                                                        [user, emoji]: [any, any],
                                                                    ) => {
                                                                ...
                                                                return (
                                                                    <button
                                                                        ...
                                                                        className={`inline-flex cursor-pointer items-center gap-1 rounded-full px-1.5 py-0.5 text-xs font-medium transition-colors select-none ${
                                                                            hasReacted
                                                                    ...
                                                                    >
                                                                        <span className="scale-95 text-sm">
                                                                            {emoji}
                                                                        </span>
                                                                        {users.length > 1 && (
            ...
            <div className="relative flex-shrink-0 border-t border-stone-200/80 bg-white/85 p-3 backdrop-blur-md dark:border-stone-800/80 dark:bg-ink/85 sm:p-4">
                    ...
                    (() => {
                        ...
                        while (cleanPreviewText.startsWith("[Reply to @")) {
                            ...
                            if (closingBracketIdx !== -1) {
                                cleanPreviewText = cleanPreviewText.substring(
                                    closingBracketIdx + 2,
                                );
                            } else {
                                const structuralRegex = /^\[Reply to @[^:]+: "([\s\S]*?)"\]\s*/;
                                if (structuralRegex.test(cleanPreviewText)) {
                                    cleanPreviewText = cleanPreviewText.replace(
                                        structuralRegex,
                                        "",
                                    );
                                } else {
                        ...
                        return (
                            <div
                                className="absolute inset-x-0 bottom-full z-40 flex items-center justify-between border-t border-stone-200/80 bg-stone-50/95 p-3 shadow-[0_-4px_16px_rgba(0,0,0,0.04)] backdrop-blur-md animate-slide-up dark:border-stone-800/80 dark:bg-ink-soft/95"
                                style={{
                ...
                {showEmojiPicker && (
                    <div
                        ref={pickerRef}
                        className="absolute bottom-[4.5rem] left-3 z-50 animate-scale-in overflow-hidden rounded-2xl border border-stone-200 shadow-pop dark:border-stone-700"
                    >
                        <EmojiPicker
                ...
                <form onSubmit={wrappedHandleSendMessage} className="flex items-center gap-2">
                    ...
                    <input
                        ...
                        onChange={(e) => {
                            ...
                            if (file.size > 25 * 1024 * 1024) {
                                showAlert(
                                    "Transmission aborted — the file exceeds the 25 MB limit.",
                                    "File too large",
                                    1,
                                );
                                e.target.value = "";
                    ...
                    <button
                        ...
                        className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border transition-all duration-150 active:scale-95 disabled:cursor-not-allowed disabled:opacity-40 ${
                            isRecording
                    ...
                    >
                        {isRecording ? (
                            <FiSquare className="h-4 w-4" fill="currentColor" />
                        ) : (
                    ...
                    <div className="relative z-10 flex max-h-[85vh] w-full max-w-2xl animate-scale-in flex-col overflow-hidden rounded-2xl border border-stone-200 bg-white shadow-pop dark:border-stone-700/60 dark:bg-ink">
                        ...
                        <div className="flex min-h-[200px] flex-1 items-center justify-center overflow-y-auto scrollbar-slim bg-stone-50 p-6 dark:bg-ink-deep/40">
                            {previewFile.fileType.startsWith("image/") && (
                                <img
                                    src={previewFile.base64Data}
                                    alt={previewFile.fileName}
                                    className="max-h-[55vh] max-w-full rounded-lg object-contain shadow-card"
                                />
                            )}
                            {previewFile.fileType.startsWith("video/") && (
                                <video
                                    ...
                                    controls
                                    autoPlay
                                    className="max-h-[55vh] max-w-full rounded-lg shadow-card"
                                />
                            )}
                            ...
                            {previewFile.fileType === "application/pdf" && (
                                <iframe
                                    ...
                                    className="h-[55vh] w-full rounded-lg border border-stone-200 bg-white dark:border-stone-700/60"
                                />
                            )}
                        </div>
                    </div>
