            ...
            <div className="flex h-16 items-center justify-between gap-2 px-3 sm:gap-3 sm:px-4 lg:px-6">
                <div className="flex min-w-0 flex-1 items-center gap-2 sm:gap-3">
                    ...
                    <div
                        ...
                        className={`ml-1 hidden shrink-0 items-center gap-2 rounded-full border px-3 py-1.5 text-xs font-medium md:flex ${
                            isConnected
                    ...
                    >
                        <span className="relative flex h-2 w-2 shrink-0">
                            ...
                            <span
                                className={`relative inline-flex h-2 w-2 rounded-full ${isConnected ? "bg-emerald-500" : "bg-rose-500"}`}
                            />
                        </span>
                ...
                <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
                    <button
                        ...
                        className={`${iconBtn} hidden min-[420px]:flex`}
                    >
                    ...
                    {joinedRoom && <LeaveRoomButton handleLeaveRoom={handleLeaveRoom} />}
