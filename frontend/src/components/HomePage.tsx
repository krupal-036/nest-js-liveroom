...
const FEATURES = [
    {
        ...
        desc: "Messages, typing indicators and presence sync instantly over persistent WebSocket connections.",
    },
    {
        icon: FiHash,
        title: "Focused rooms",
        desc: "Spin up a room for any topic in one click — create, join and clean up with zero friction.",
    },
    {
        icon: FiPaperclip,
        title: "Files & media",
        desc: "Share images, documents and PDFs up to 25 MB with inline previews and one-tap downloads.",
    },
    {
        icon: FiMic,
        title: "Voice memos",
        desc: "Record and send audio notes directly from the composer — no external tools required.",
    },
    {
        icon: FiSmile,
        title: "Reactions & replies",
        desc: "Keep conversations lively and threaded with emoji reactions and contextual quote replies.",
    },
    {
        icon: FiShield,
        title: "Admin controls",
        desc: "Moderate with confidence: disable, blacklist or remove users from a dedicated control panel.",
    },
];
...
const MockMessage: React.FC<{
    ...
    own?: boolean;
    gradient?: string;
}> = ({ name, initial, text, own = false, gradient = "" }) => (
    ...
    return (
        <div className="min-h-dvh bg-cream-soft text-stone-900 dark:bg-ink-deep dark:text-stone-100">
            ...
            <header className="sticky top-0 z-40 border-b border-stone-200/60 bg-cream-soft/80 backdrop-blur-xl dark:border-stone-800/60 dark:bg-ink-deep/80">
                <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between gap-3 px-4 sm:px-6">
                    ...
                    <nav className="flex items-center gap-1 sm:gap-2" aria-label="Main">
                        ...
                        <Link
                            to="/about"
                            className="rounded-xl px-3 py-2 text-sm font-medium text-stone-500 transition-colors hover:bg-stone-200/50 hover:text-stone-800 dark:text-stone-400 dark:hover:bg-white/5 dark:hover:text-stone-200"
                        >
                            About
                        </Link>
                        ...
                        <button
                            ...
                            className="ml-1 h-10 rounded-xl bg-emerald-600 px-4 text-sm font-semibold text-white shadow-lg shadow-emerald-600/25 transition-all duration-200 hover:bg-emerald-500 active:scale-95"
                        >
            ...
            <main>
                ...
                <section className="relative overflow-hidden">
                    ...
                    <div className="relative mx-auto grid w-full max-w-6xl gap-14 px-4 pt-16 pb-20 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-10 lg:pt-24 lg:pb-28">
                        ...
                        <div className="max-w-2xl">
                            ...
                            <h1
                                className="mt-5 animate-rise-in text-4xl leading-[1.08] font-extrabold tracking-tight sm:text-5xl lg:text-6xl"
                            ...
                            <p
                                className="mt-5 max-w-xl animate-rise-in text-base leading-relaxed text-stone-600 sm:text-lg dark:text-stone-400"
                                style={{ animationDelay: "120ms" }}
                            >
                                NestJS Live Room is a fast, focused chat workspace — create a room,
                                invite your people, and start sharing messages, files and voice
                                memos in milliseconds. No noise. No clutter.
                            </p>
                            ...
                            <ul
                                className="mt-8 flex animate-rise-in flex-wrap gap-x-6 gap-y-2 text-[13px] font-medium text-stone-500 dark:text-stone-400"
                                style={{ animationDelay: "240ms" }}
                            >
                                {["Free forever", "No setup required", "Works on any device"].map(
                                    (item) => (
                        ...
                        <div
                            className="relative mx-auto w-full max-w-md animate-rise-in lg:max-w-none"
                            style={{ animationDelay: "200ms" }}
                        >
                            <div
                                aria-hidden
                                className="absolute -inset-6 rounded-[2rem] bg-emerald-500/10 blur-2xl"
                            />
                            ...
                            <div className="relative overflow-hidden rounded-2xl border border-stone-200/80 bg-white shadow-pop dark:border-stone-800 dark:bg-ink">
                                ...
                                <div className="space-y-4 px-4 py-5">
                                    <MockMessage
                                        ...
                                        text="The new dashboard mockups just landed 🎨"
                                    />
                                    <MockMessage
                                        own
                                        initial="Y"
                                        gradient="bg-gradient-to-tr from-emerald-600 to-emerald-400"
                                        text="Ship the dark mode first — it looks stunning."
                                    />
                                    <MockMessage
                                        name="Marco"
                                        initial="M"
                                        gradient="bg-gradient-to-tr from-amber-500 to-orange-500"
                                        text="Agreed. Voice notes for feedback would be 👌"
                                    />
                ...
                <section
                    id="features"
                    className="border-t border-stone-200/60 bg-white py-20 dark:border-stone-800/60 dark:bg-ink/40"
                    ...
                    <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
                        <div className="mx-auto max-w-2xl text-center">
                            ...
                            <p className="mt-3 text-stone-500 dark:text-stone-400">
                                Purpose-built features, zero bloat — each one engineered for speed
                                and clarity.
                            </p>
                        </div>
                ...
                <section className="py-20">
                    <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
                        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-800 px-6 py-14 text-center shadow-pop sm:px-12">
                            <div
                                aria-hidden
                                className="absolute inset-0 bg-[linear-gradient(to_right,rgb(255_255_255/0.06)_1px,transparent_1px),linear-gradient(to_bottom,rgb(255_255_255/0.06)_1px,transparent_1px)] bg-[size:32px_32px]"
                            />
