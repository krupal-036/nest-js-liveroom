import { FiArrowLeft, FiArrowRight, FiActivity, FiCheck, FiZap, FiHash, FiPaperclip, FiMic, FiSmile, FiShield } from 'react-icons/fi';
                ...
                <section className="border-t border-stone-200/60 py-14 dark:border-stone-800/60">
                    <div className="rounded-3xl border border-stone-200/80 bg-white p-8 text-center shadow-card sm:p-10 dark:border-stone-800/80 dark:bg-ink">
                        ...
                        <p className="mx-auto mt-4 max-w-3xl text-sm leading-relaxed text-stone-600 sm:text-base dark:text-stone-400">
                            ...
                            access control, WebSocket event orchestration, file streaming with inline previews, and a fully
                            theme-aware interface — all wrapped in a fast, accessible UI that works beautifully from phones
                            to large displays.
                        </p>
                        {!user && (
